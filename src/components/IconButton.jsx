...
function IconButton({ content, iconb, icona, w, h, bg, c, is, ts, title, extraClass, onClick }) {
  return (
    <button className={`icon-btn btn-width-${w} btn-height-${h} btn-bg-${bg} btn-clr-${c} ${extraClass}`} onClick={onClick} title={title}>
